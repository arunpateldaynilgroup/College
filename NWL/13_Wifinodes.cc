...
main(int argc, char * argv[]) {
  ...
  mobility.SetMobilityModel("ns3::RandomWalk2dMobilityModel",
    "Bounds", RectangleValue(Rectangle(-50, 50, -25,
      50)));
  ...
  csma.EnablePcapAll("wifinodes-echo", false);
  ...
  AnimationInterface anim("13_wireless-animation.xml"); // Mandatory
  ...
  //anim.EnableIpv4RouteTracking ("routingtable-wireless1.xml", Seconds (0), Seconds (5), Seconds (0.25)); //Optional
  //anim.EnableWifiMacCounters (Seconds (0), Seconds (10)); //Optional
  // anim.EnableWifiPhyCounters (Seconds (0), Seconds (10)); //Optional
  //AnimationInterface anim ("routingtable-wireless1.xml");
  Simulator::Run();
  Simulator::Destroy();
  return 0;
}
